...
ubi_$(FLASH_TYPE)_config_script:
	...
	@echo setenv bootcmd \' bootlogo 0 0 0 0 0\; $(wifi24mclkcmd)\; $(wifirstoffcmd)\; $(kernel$(BOOTCMD))\;$(rootfs$(BOOTCMD)) $(wifirstoncmd)\; bootm $(KERNELBOOTADDR)\;$(kernel$(BOOTREC))\; bootm $(KERNELBOOTADDR) >> $(SCRIPTDIR)/set_config
